...
- (id)init
{
	if (self = [super init]) {
		...
		[self setAllowsNonContiguousLayout:NO]; // Setting this to YES sometimes causes "an extra toolbar" and other graphical glitches to sometimes appear in the text view when one sets a temporary attribute, reported as ID #5832329 to Apple
